...
@Component({
  selector: 'app-different-bank',
  templateUrl: './different-bank.component.html',
  styleUrls: ['./different-bank.component.css']
})
export class DifferentBankComponent implements OnInit {
